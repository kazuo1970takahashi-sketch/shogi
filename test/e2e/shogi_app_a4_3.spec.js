...
// ============================================================
// §2.1 現クラス強調表示テストは A-4.5 で撤廃(色強調 → 3 セクション分離に移行)
// 対応する新規アサーションは shogi_app_a4_5.spec.js のセクション分離テストで担保
// ============================================================
...
test.describe('A-4.3 §2.5: F7 編集モーダル last_class', () => {
  ...
  // A-4.5: 「未設定」radio 撤廃。me-last-class radio は 2 つ(A / B)が DOM に存在
  ...
  // A-4.5: last_class=null の member は A/B どちらも未 checked で開く
  ...
  // A-4.5: last_class=null の member を A/B どちらも選ばずに保存 → 既存 null を維持
