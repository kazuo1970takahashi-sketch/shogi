...
// CLOUD-TID-GUARD-001b (#800 案#2): 送信先の大会ガード（事前照会→確認→未連携ガード→書き込み）と
//   precheck の⚠注記でさらに伸びたため窓を 6400→9000・間隔を 900→1400 に拡大（チェック内容は不変）。
//   実測（001b 時点）: res&&res.ok は関数先頭から 6842 文字・markSaveStatus('cloud') までの間隔は 944 文字。
