# Phase A-T Stage 2a 仕様書 v1.4:UI テストヘルパ実装(`expectClickable` + `clickAndExpectChange` + `triggerInputFileAndExpectChange`)

**配置先**: `docs/specs/20260506_0752_shogi_at_stage_2a_helpers_spec_v1.md`(同名上書き、v1.3 → v1.4)
**最終更新**: 2026-05-06 13:07 JST
**対象ブランチ**: `feat/phase-a-t-stage-2a-helpers`(main 1aa8e02 から派生、現 HEAD 0c96cb2 = v1.3 用 Codex 再レビュー依頼追加)
...
- 本仕様書(v1.4)が Codex 独立再レビュー A 以上(B+ → A 判定狙い、Quick Review 指定で Must Fix 吸収確認のみ)
- 本仕様書(v1.3)が ChatGPT メタレビュー A 以上(v1.3 簡易確認、A 判定維持済み)
