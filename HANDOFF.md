...
**SAVE-UX post-quota follow-up map**: `docs/notes/20260513_shogi_save_ux_status_map.md` §14（PR #78〜#80 後の到達点、save-verify / storage-quota の 2 系統表、未回収 Nice to Have 8 項目、次タスク候補 8 件を整理。次候補は `SAVE-UX-MASTER-V2-METADATA`、足場固めなら `SAVE-UX-TEST-STRUCTURAL-MATCH`。`callsiteId` 命名規則は §13）
