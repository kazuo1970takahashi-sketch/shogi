...
**SAVE-UX-WARN-AGGREGATION 設計**: `docs/specs/20260513_shogi_save_ux_warn_aggregation_design.md`（warn 集約・kind 分類・三層分離原則の設計。実装は後続 SAVE-UX-WARN-AGGREGATION-IMPL）
